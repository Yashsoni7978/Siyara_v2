...
export default function Studio() {
  ...
  return (
    <section id="studio" className="relative py-16 sm:py-20 bg-[#F3EFE3] text-[#101613] overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 flex items-center gap-2 text-[10px] font-sans text-[#101613] font-bold tracking-widest uppercase bg-[#ECE7D8]/90 px-3 py-1.5 border border-[#0B5E49]/30 backdrop-blur-md">
                  <MapPin className="w-3 h-3 text-[#0B5E49]" />
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            <motion.h2
              ...
              className="font-serif text-4xl sm:text-5xl lg:text-6xl text-[#101613] font-normal leading-[1.04] mb-6"
            >
              Rooted in Jaipur. <br />
              Driven by innovation. <br />
              Focused on <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#B9923F] to-[#0B5E49] font-normal">impact.</span>
            </motion.h2>
            ...
            <motion.div
              ...
              className="p-6 bg-[#ECE7D8] border border-[#0B5E49]/20 relative overflow-hidden flex items-center justify-between"
            >
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <MapPin className="w-4 h-4 text-[#0B5E49]" />
                  <span className="text-xs font-sans font-bold text-[#0B5E49] tracking-widest uppercase">
                    JAIPUR, INDIA
                  </span>
                </div>
                <p className="text-xs font-sans text-[#101613]/70 font-light">
                  Studio Headquarters & Creative Hub
                </p>
              </div>

              <div className="hidden sm:block">
                <div className="w-2.5 h-2.5 rounded-full bg-[#B9923F] animate-ping" />
              </div>
            </motion.div>
          </div>
